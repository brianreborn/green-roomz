...
export {
  ...
  cpuRingSyncMeta as sm11CpuRingSyncMeta,
  cpuRingDumpMeta as sm11CpuRingDumpMeta,
  ...
  verifyRingSyncMeta as sm11VerifyRingSyncMeta,
  verifyRingDumpMeta as sm11VerifyRingDumpMeta,
  probeSm11,
  createSm11Assist,
